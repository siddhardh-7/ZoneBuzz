...
package com.siddhardhadarsi.zonebuzz.core.timezone
...
import com.siddhardhadarsi.zonebuzz.application.di.ApplicationScope
import com.siddhardhadarsi.zonebuzz.application.di.Dispatcher
import com.siddhardhadarsi.zonebuzz.application.di.ZoneBuzzDispatchers
...
internal class TimeZoneBroadcastMonitor @Inject constructor(
    ...
    @Dispatcher(ZoneBuzzDispatchers.IO) private val ioDispatcher: CoroutineDispatcher,
) : TimeZoneMonitor {
